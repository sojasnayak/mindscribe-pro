...
@app.post("/analyze/guide")
async def analyze_guide_agent(entry: JournalEntry):
    try:
        # The prompt that defines the AI's personality and task
        system_prompt = "You are The Guide, an empathetic AI journaling assistant. Your role is to listen to the user's entry and provide a single, concise, and supportive reflection. Do not ask questions. Be warm and encouraging."
